...
public final class SctHandlerDescription implements IZipContentsHandlerCsv {
	...
	private static final String SNOMED_CONCEPT_FULLY_SPECIFIED_NAME = "900000000000003001";
	// https://docs.snomed.org/snomed-international-documents/snomed-ct-glossary/s/synonym
	private static final String SNOMED_CONCEPT_SYNONYM = "900000000000013009";
	...
	public void accept(CSVRecord theRecord) {
		...
		if ((isSynonym || SNOMED_CONCEPT_FULLY_SPECIFIED_NAME.equals(typeId))
			...
			concept.addDesignation()
					...
					.setUseCode(typeId)
					.setUseDisplay(isSynonym ? "Synonym (core metadata concept)" : "Fully specified name");
		}
	}
}
